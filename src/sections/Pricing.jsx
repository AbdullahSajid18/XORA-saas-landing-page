        ...
        <div className="container">
          <div className="relative pb-40 mx-auto border-l border-r max-w-960 pricing-head_before border-s2 bg-s1/50 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            ...
            <div className="relative z-4 mx-auto flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]">
              ...
              <div
                className={clsx(
                  "absolute g4 rounded-14 before:h-100 pricing-head_btn_before left-2 top-2 h-[calc(100%-16px)] w-[calc(50%-8px)] overflow-hidden shadow-400 transition-transform duration-500",
          ...
          <div className="relative flex items-start -mt-12 scroll-hide z-2 max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
            {plans.map((plan, index) => (
              ...
              >
                ...
                {index === 1 && <p className="text-center small-compact mt-9 text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">Limited time offer.</p>}
              </div>
            ))}
          </div>
        </div>
